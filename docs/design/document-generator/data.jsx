// Mock data for the bitable sidebar plugin prototype.
...
const TEMPLATES = [
  {
    id: 'tpl_001', name: '标准商业合同模板', varCount: 8,
    updatedAt: '5 月 10 日', category: '合同类', kind: 'doc',
    variables: [
...
// Sample rows to mock the bitable backdrop behind the sidebar.
const TABLE_ROWS = [
...
window.MockData = { TABLE_FIELDS, TEMPLATES, CATEGORIES, TABLE_ROWS };
